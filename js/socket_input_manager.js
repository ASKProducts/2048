...
SocketInputManager.prototype.listen = function () {
  ...
  //io.on('connection', function (socket) {
    //console.log("connected from input_manager :)")
...
SocketInputManager.prototype.keepPlaying = function (event) {
  event.preventDefault();
  this.emit("keepPlaying");
};

SocketInputManager.prototype.bindButtonPress = function (selector, fn) {
